...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/pizzicato.js":[function(require,module,exports) {
var define;
...
!function (e) {
  ...
  var o = {},
      s = o,
      a = "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports,
  ...
  d.connect = function (e) {
    ...
    function r(e, t) {
      return navigator.getUserMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia, navigator.getUserMedia ? void navigator.getUserMedia({
        audio: !0
      }, function (e) {
        u.getRawSourceNode = function () {
    ...
    applyAttack: {
      ...
      value: function value() {
        ...
        if (this.fadeNode.gain.cancelScheduledValues(s.context.currentTime), this.fadeNode.gain.setValueAtTime(e, s.context.currentTime), !this.attack) return void this.fadeNode.gain.setValueAtTime(1, o.context.currentTime);
        var t = (1 - this.fadeNode.gain.value) * this.attack;
        this.fadeNode.gain.setValueAtTime(this.fadeNode.gain.value, o.context.currentTime), this.fadeNode.gain.linearRampToValueAtTime(1, o.context.currentTime + t);
      }
    },
    stopWithRelease: {
      enumerable: !1,
      value: function value(e) {
        ...
        if (this.fadeNode.gain.cancelScheduledValues(s.context.currentTime), this.fadeNode.gain.setValueAtTime(n, s.context.currentTime), !this.release) return void i();
        var a = this.fadeNode.gain.value * this.release;
        this.fadeNode.gain.setValueAtTime(this.fadeNode.gain.value, o.context.currentTime), this.fadeNode.gain.linearRampToValueAtTime(1e-5, o.context.currentTime + a), window.setTimeout(function () {
          i();
        }, 1e3 * a);
      }
    }
  ...
  o.Effects.LowPassFilter.prototype = p, o.Effects.HighPassFilter.prototype = p, o.Effects.Distortion = function (e) {
    ...
    this.inputNode = o.context.createGain(), this.outputNode = o.context.createGain(), o.context.createStereoPanner ? (this.pannerNode = o.context.createStereoPanner(), this.inputNode.connect(this.pannerNode), this.pannerNode.connect(this.outputNode)) : this.inputNode.connect(this.outputNode);
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/pizzicato.js"], null)
//# sourceMappingURL=/pizzicato.5ed6ae9d.js.map