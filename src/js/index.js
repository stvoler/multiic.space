...
preloader('.item').then(() => {
    ...
    tl3.fromTo(".block-3 .title", {transform: 'translateY(0px) scaleY(1)', lineHeight: 1}, {delay: 0.3, duration: 2.34, opacity: 0, transform: 'translateY(-400px) scaleY(4.5)', lineHeight: 0.8, ease: "[0.74,0.2,1,-0.22]"}, ">1.8")
    ...
    tl4.fromTo(".block-4 .title", {transform: 'translateY(0px) scaleY(1)', lineHeight: 1}, {delay: 0.3, duration: 2.34, opacity: 0, transform: 'translateY(-500px) scaleY(4.5)', lineHeight: 0.8, ease: "[0.74,0.2,1,-0.22]"}, ">1.8")
    ...
    tl4.fromTo(settings, {offset: 0}, {duration: 1.8, offset: 0.5})
    ...
    tl5.fromTo(settings, {offset: 0.5}, {delay: 0.11, duration: 1.8, offset: 1.15})
